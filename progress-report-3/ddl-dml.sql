...
(
	  ...
	  PRIMARY KEY (id),
		CONSTRAINT fk_riwayat_baca_pengguna
			FOREIGN KEY (id_pengguna) REFERENCES pengguna (id),
		CONSTRAINT fk_riwayat_baca_buku
			FOREIGN KEY (id_buku) REFERENCES buku (id)
);

-- Table status riwayat bayar
CREATE TABLE status_riwayat_bayar
(
		id              INT NOT NULL AUTO_INCREMENT,
		id_pengguna     INT NOT NULL,
		id_buku         INT NOT NULL,
		...
		PRIMARY KEY (id),
		CONSTRAINT fk_status_riwayat_baca
			FOREIGN KEY (id_pengguna) REFERENCES riwayat_baca (id)
);
...
INSERT INTO pengguna (nama, usia, jenis_peminatan_buku) VALUES
('Abdul', 18, 'Fiksi'),
('Ana', 20, 'Non-Fiksi'),
('Dimas', 21, 'Biografi'),
('Malik', 20, 'Teknologi'),
...
INSERT INTO akun (id_pengguna, nama, kata_sandi) VALUES
(1, 'abdul01', 'password1'),
(2, 'ana01', 'password2'),
(3, 'dimas01', 'password3'),
(4, 'malik01', 'password4'),
...
INSERT INTO buku (id_genre, nama, penulis, penerbit, jenis, jum_halaman, jum_bagian, harga) VALUES
...
INSERT INTO riwayat_baca (id_pengguna, id_buku, nilai, komentar, tanggal) VALUES
...
INSERT INTO status_riwayat_bayar (id_pengguna, id_buku, id_riwayat_baca, harga, tanggal_bayar) VALUES
